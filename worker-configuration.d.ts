/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: af96409bc6a67629ce89b9cd2e411041)
// Runtime types generated with workerd@1.20260708.1 2026-02-25 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	IMAGE_BUCKET: R2Bucket;
	MAX_FILE_SIZE_MB: "150";
	WORKER_URL: "https://gh-image-uploader.jasonpraful.workers.dev";
	MCP_OBJECT: DurableObjectNamespace<import("./src/index").ImageUploaderMCP>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ImageUploaderMCP";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MAX_FILE_SIZE_MB" | "WORKER_URL">> {}
}
